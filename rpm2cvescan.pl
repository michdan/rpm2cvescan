...
foreach my $p ( keys %packages_list )
{
        ...
        delete $packages_list{$p} if ( $p =~ m/^python-perf/ );
        delete $packages_list{$p} if ( $p =~ m/^perf-/ );
        delete $packages_list{$p} if ( $p =~ m/^dbus-glib/ );
...
foreach my $p ( keys %packages_nice )
{
        ...
        delete $packages_nice{$p} if ( $p =~ m/^python-perf/ );
        delete $packages_nice{$p} if ( $p =~ m/^perf-/ );
        delete $packages_nice{$p} if ( $p =~ m/^dbus-glib/ );
